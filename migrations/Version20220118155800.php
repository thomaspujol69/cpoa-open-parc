 ...
 */
final class Version20220118155800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__promo_code AS SELECT id, label, code FROM promo_code');
        ...
        $this->addSql('INSERT INTO promo_code (id, label, code) SELECT id, label, code FROM __temp__promo_code');
