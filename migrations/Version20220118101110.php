 ...
 */
final class Version20220118101110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE day ADD COLUMN cat1_disp_pl INTEGER NOT NULL');
        $this->addSql('ALTER TABLE day ADD COLUMN cat2_disp_pl INTEGER NOT NULL');
        ...
        $this->addSql('CREATE TABLE ticket_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promo_code_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, price DOUBLE PRECISION DEFAULT NULL, CONSTRAINT FK_BE0542112FAE4625 FOREIGN KEY (promo_code_id) REFERENCES promo_code (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_E00CEDDE99E6F5DF ON booking (player_id)');
        $this->addSql('CREATE INDEX IDX_E00CEDDEE3184009 ON booking (court_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__day AS SELECT id, date, begining, description, cat1_price, cat2_price FROM day');
        $this->addSql('DROP TABLE day');
        $this->addSql('CREATE TABLE day (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, date DATE NOT NULL, begining TIME NOT NULL, description CLOB DEFAULT NULL, cat1_price INTEGER NOT NULL, cat2_price INTEGER NOT NULL)');
        $this->addSql('INSERT INTO day (id, date, begining, description, cat1_price, cat2_price) SELECT id, date, begining, description, cat1_price, cat2_price FROM __temp__day');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ticket_type AS SELECT id, promo_code_id, label, price FROM ticket_type');
        $this->addSql('DROP TABLE ticket_type');
        $this->addSql('CREATE TABLE ticket_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promo_code_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL, price DOUBLE PRECISION DEFAULT NULL)');
        $this->addSql('INSERT INTO ticket_type (id, promo_code_id, label, price) SELECT id, promo_code_id, label, price FROM __temp__ticket_type');
        $this->addSql('DROP TABLE __temp__ticket_type');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BE0542112FAE4625 ON ticket_type (promo_code_id)');
    }
