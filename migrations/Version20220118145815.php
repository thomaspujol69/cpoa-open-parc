 ...
 */
final class Version20220118145815 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO ticket_type (id, promo_code_id, label, price_percentage) SELECT id, promo_code_id, label, price FROM __temp__ticket_type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO ticket_type (id, promo_code_id, label, price) SELECT id, promo_code_id, label, price_percentage FROM __temp__ticket_type');
        $this->addSql('DROP TABLE __temp__ticket_type');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BE0542112FAE4625 ON ticket_type (promo_code_id)');
    }
}
