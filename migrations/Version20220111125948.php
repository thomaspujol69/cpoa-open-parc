 ...
 */
final class Version20220111125948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE day ADD COLUMN cat1_price INTEGER NOT NULL');
        $this->addSql('ALTER TABLE day ADD COLUMN cat2_price INTEGER NOT NULL');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, chair_arbitrator_id, court_id, day_id, is_final, date, hour, score FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chair_arbitrator_id INTEGER DEFAULT NULL, court_id INTEGER DEFAULT NULL, day_id INTEGER DEFAULT NULL, is_final BOOLEAN NOT NULL, date DATE NOT NULL, hour VARCHAR(255) NOT NULL COLLATE BINARY, score VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_232B318CAE363C0C FOREIGN KEY (chair_arbitrator_id) REFERENCES arbitrator (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318CE3184009 FOREIGN KEY (court_id) REFERENCES court (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318C9C24126 FOREIGN KEY (day_id) REFERENCES day (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game (id, chair_arbitrator_id, court_id, day_id, is_final, date, hour, score) SELECT id, chair_arbitrator_id, court_id, day_id, is_final, date, hour, score FROM __temp__game');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_E00CEDDE99E6F5DF ON booking (player_id)');
        $this->addSql('CREATE INDEX IDX_E00CEDDEE3184009 ON booking (court_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__day AS SELECT id, date, begining, description FROM day');
        ...
        $this->addSql('INSERT INTO day (id, date, begining, description) SELECT id, date, begining, description FROM __temp__day');
        $this->addSql('DROP TABLE __temp__day');
        $this->addSql('DROP INDEX IDX_232B318CAE363C0C');
        $this->addSql('DROP INDEX IDX_232B318CE3184009');
        $this->addSql('DROP INDEX IDX_232B318C9C24126');
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, chair_arbitrator_id, court_id, day_id, is_final, date, hour, score FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chair_arbitrator_id INTEGER DEFAULT NULL, court_id INTEGER DEFAULT NULL, day_id INTEGER DEFAULT NULL, is_final BOOLEAN NOT NULL, date DATE NOT NULL, hour VARCHAR(255) NOT NULL, score VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO game (id, chair_arbitrator_id, court_id, day_id, is_final, date, hour, score) SELECT id, chair_arbitrator_id, court_id, day_id, is_final, date, hour, score FROM __temp__game');
        $this->addSql('DROP TABLE __temp__game');
        $this->addSql('CREATE INDEX IDX_232B318CAE363C0C ON game (chair_arbitrator_id)');
        $this->addSql('CREATE INDEX IDX_232B318CE3184009 ON game (court_id)');
