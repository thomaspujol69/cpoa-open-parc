 ...
 */
final class Version20220111085150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__arbitrator AS SELECT id, nb_simple_matchs, nb_double_matchs, nationality FROM arbitrator');
        $this->addSql('DROP TABLE arbitrator');
        $this->addSql('CREATE TABLE arbitrator (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nb_simple_matchs INTEGER NOT NULL, nb_double_matchs INTEGER NOT NULL, nationality VARCHAR(255) NOT NULL COLLATE BINARY, name VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO arbitrator (id, nb_simple_matchs, nb_double_matchs, nationality) SELECT id, nb_simple_matchs, nb_double_matchs, nationality FROM __temp__arbitrator');
        $this->addSql('DROP TABLE __temp__arbitrator');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, chair_arbitrator_id, court_id, is_final, date, hour, score FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chair_arbitrator_id INTEGER DEFAULT NULL, court_id INTEGER DEFAULT NULL, is_final BOOLEAN NOT NULL, date DATE NOT NULL, hour VARCHAR(255) NOT NULL COLLATE BINARY, score VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_232B318CAE363C0C FOREIGN KEY (chair_arbitrator_id) REFERENCES arbitrator (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318CE3184009 FOREIGN KEY (court_id) REFERENCES court (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game (id, chair_arbitrator_id, court_id, is_final, date, hour, score) SELECT id, chair_arbitrator_id, court_id, is_final, date, hour, score FROM __temp__game');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ticket AS SELECT id, user_id, ticket_type_id, promo_code_id, date FROM ticket');
        $this->addSql('DROP TABLE ticket');
        $this->addSql('CREATE TABLE ticket (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, ticket_type_id INTEGER DEFAULT NULL, promo_code_id INTEGER DEFAULT NULL, date DATE NOT NULL, CONSTRAINT FK_97A0ADA3A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_97A0ADA3C980D5C1 FOREIGN KEY (ticket_type_id) REFERENCES ticket_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_97A0ADA32FAE4625 FOREIGN KEY (promo_code_id) REFERENCES promo_code (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO ticket (id, user_id, ticket_type_id, promo_code_id, date) SELECT id, user_id, ticket_type_id, promo_code_id, date FROM __temp__ticket');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ticket_type AS SELECT id, promo_code_id, label, price FROM ticket_type');
        $this->addSql('DROP TABLE ticket_type');
        $this->addSql('CREATE TABLE ticket_type (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, promo_code_id INTEGER DEFAULT NULL, label VARCHAR(255) NOT NULL COLLATE BINARY, price DOUBLE PRECISION NOT NULL, CONSTRAINT FK_BE0542112FAE4625 FOREIGN KEY (promo_code_id) REFERENCES promo_code (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO ticket_type (id, promo_code_id, label, price) SELECT id, promo_code_id, label, price FROM __temp__ticket_type');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__arbitrator AS SELECT id, nb_simple_matchs, nb_double_matchs, nationality FROM arbitrator');
        $this->addSql('DROP TABLE arbitrator');
        $this->addSql('CREATE TABLE arbitrator (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nb_simple_matchs INTEGER NOT NULL, nb_double_matchs INTEGER NOT NULL, nationality VARCHAR(255) NOT NULL, is_chair BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO arbitrator (id, nb_simple_matchs, nb_double_matchs, nationality) SELECT id, nb_simple_matchs, nb_double_matchs, nationality FROM __temp__arbitrator');
        $this->addSql('DROP TABLE __temp__arbitrator');
        $this->addSql('DROP INDEX IDX_A03E8B9D8C36C26A');
        $this->addSql('DROP INDEX IDX_A03E8B9DE48FD905');
