 ...
 */
final class Version20220123162218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ball_boy AS SELECT id, ball_boys_team_id, name FROM ball_boy');
        ...
        $this->addSql('INSERT INTO ball_boy (id, ball_boys_team_id, name) SELECT id, ball_boys_team_id, name FROM __temp__ball_boy');
        $this->addSql('DROP TABLE __temp__ball_boy');
        $this->addSql('CREATE INDEX IDX_EA58D4D98A371DB4 ON ball_boy (ball_boys_team_id)');
        $this->addSql('DROP INDEX IDX_A9E9AA48E48FD905');
        $this->addSql('DROP INDEX IDX_A9E9AA488A371DB4');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ball_boys_team_game AS SELECT ball_boys_team_id, game_id FROM ball_boys_team_game');
        $this->addSql('DROP TABLE ball_boys_team_game');
        $this->addSql('CREATE TABLE ball_boys_team_game (ball_boys_team_id INTEGER NOT NULL, game_id INTEGER NOT NULL, PRIMARY KEY(ball_boys_team_id, game_id), CONSTRAINT FK_A9E9AA488A371DB4 FOREIGN KEY (ball_boys_team_id) REFERENCES ball_boys_team (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A9E9AA48E48FD905 FOREIGN KEY (game_id) REFERENCES game (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO ball_boys_team_game (ball_boys_team_id, game_id) SELECT ball_boys_team_id, game_id FROM __temp__ball_boys_team_game');
        $this->addSql('DROP TABLE __temp__ball_boys_team_game');
        $this->addSql('CREATE INDEX IDX_A9E9AA48E48FD905 ON ball_boys_team_game (game_id)');
        $this->addSql('CREATE INDEX IDX_A9E9AA488A371DB4 ON ball_boys_team_game (ball_boys_team_id)');
        ...
        $this->addSql('DROP INDEX IDX_232B318CEAF9CA5F');
        $this->addSql('DROP INDEX IDX_232B318CFDF0E181');
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, chair_arbitrator_id, court_id, day_id, team_winner_id, player_winner_id, is_final, date, hour, score, is_double, is_women FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chair_arbitrator_id INTEGER DEFAULT NULL, court_id INTEGER DEFAULT NULL, day_id INTEGER NOT NULL, team_winner_id INTEGER DEFAULT NULL, player_winner_id INTEGER DEFAULT NULL, is_final BOOLEAN NOT NULL, date DATE NOT NULL, hour VARCHAR(255) NOT NULL COLLATE BINARY, score VARCHAR(255) DEFAULT NULL COLLATE BINARY, is_double BOOLEAN NOT NULL, is_women BOOLEAN NOT NULL, CONSTRAINT FK_232B318CAE363C0C FOREIGN KEY (chair_arbitrator_id) REFERENCES arbitrator (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318CE3184009 FOREIGN KEY (court_id) REFERENCES court (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318C9C24126 FOREIGN KEY (day_id) REFERENCES day (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318CEAF9CA5F FOREIGN KEY (team_winner_id) REFERENCES team (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_232B318CFDF0E181 FOREIGN KEY (player_winner_id) REFERENCES player (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game (id, chair_arbitrator_id, court_id, day_id, team_winner_id, player_winner_id, is_final, date, hour, score, is_double, is_women) SELECT id, chair_arbitrator_id, court_id, day_id, team_winner_id, player_winner_id, is_final, date, hour, score, is_double, is_women FROM __temp__game');
        ...
        $this->addSql('CREATE INDEX IDX_232B318CFDF0E181 ON game (player_winner_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__player AS SELECT id, team_id, nationality, first_name, last_name, is_women FROM player');
        $this->addSql('DROP TABLE player');
        $this->addSql('CREATE TABLE player (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, team_id INTEGER DEFAULT NULL, nationality VARCHAR(255) NOT NULL COLLATE BINARY, first_name VARCHAR(255) NOT NULL COLLATE BINARY, last_name VARCHAR(255) NOT NULL COLLATE BINARY, is_women BOOLEAN NOT NULL, CONSTRAINT FK_98197A65296CD8AE FOREIGN KEY (team_id) REFERENCES team (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO player (id, team_id, nationality, first_name, last_name, is_women) SELECT id, team_id, nationality, first_name, last_name, is_women FROM __temp__player');
        ...
        $this->addSql('ALTER TABLE team ADD COLUMN is_women BOOLEAN NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ball_boy AS SELECT id, ball_boys_team_id, name FROM ball_boy');
        $this->addSql('DROP TABLE ball_boy');
        $this->addSql('CREATE TABLE ball_boy (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ball_boys_team_id INTEGER DEFAULT NULL, name VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO ball_boy (id, ball_boys_team_id, name) SELECT id, ball_boys_team_id, name FROM __temp__ball_boy');
        $this->addSql('DROP TABLE __temp__ball_boy');
        $this->addSql('CREATE INDEX IDX_EA58D4D98A371DB4 ON ball_boy (ball_boys_team_id)');
        $this->addSql('DROP INDEX IDX_A9E9AA488A371DB4');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ball_boys_team_game AS SELECT ball_boys_team_id, game_id FROM ball_boys_team_game');
        $this->addSql('DROP TABLE ball_boys_team_game');
        $this->addSql('CREATE TABLE ball_boys_team_game (ball_boys_team_id INTEGER NOT NULL, game_id INTEGER NOT NULL, PRIMARY KEY(ball_boys_team_id, game_id))');
        $this->addSql('INSERT INTO ball_boys_team_game (ball_boys_team_id, game_id) SELECT ball_boys_team_id, game_id FROM __temp__ball_boys_team_game');
        $this->addSql('DROP TABLE __temp__ball_boys_team_game');
        $this->addSql('CREATE INDEX IDX_A9E9AA488A371DB4 ON ball_boys_team_game (ball_boys_team_id)');
        $this->addSql('CREATE INDEX IDX_A9E9AA48E48FD905 ON ball_boys_team_game (game_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, chair_arbitrator_id, court_id, day_id, team_winner_id, player_winner_id, is_final, date, hour, score, is_double, is_women FROM game');
        $this->addSql('DROP TABLE game');
        $this->addSql('CREATE TABLE game (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, chair_arbitrator_id INTEGER DEFAULT NULL, court_id INTEGER DEFAULT NULL, day_id INTEGER NOT NULL, team_winner_id INTEGER DEFAULT NULL, player_winner_id INTEGER DEFAULT NULL, is_final BOOLEAN NOT NULL, date DATE NOT NULL, hour VARCHAR(255) NOT NULL, score VARCHAR(255) DEFAULT NULL, is_double BOOLEAN NOT NULL, is_women BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO game (id, chair_arbitrator_id, court_id, day_id, team_winner_id, player_winner_id, is_final, date, hour, score, is_double, is_women) SELECT id, chair_arbitrator_id, court_id, day_id, team_winner_id, player_winner_id, is_final, date, hour, score, is_double, is_women FROM __temp__game');
        $this->addSql('DROP TABLE __temp__game');
        $this->addSql('CREATE INDEX IDX_232B318CAE363C0C ON game (chair_arbitrator_id)');
        $this->addSql('CREATE INDEX IDX_232B318CE3184009 ON game (court_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__player AS SELECT id, team_id, nationality, first_name, last_name, is_women FROM player');
        $this->addSql('DROP TABLE player');
        $this->addSql('CREATE TABLE player (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, team_id INTEGER DEFAULT NULL, nationality VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, is_women BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO player (id, team_id, nationality, first_name, last_name, is_women) SELECT id, team_id, nationality, first_name, last_name, is_women FROM __temp__player');
        $this->addSql('DROP TABLE __temp__player');
        $this->addSql('CREATE INDEX IDX_98197A65296CD8AE ON player (team_id)');
        $this->addSql('DROP INDEX IDX_813161BF99E6F5DF');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3D8C939E77153098 ON promo_code (code)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3D8C939EC980D5C1 ON promo_code (ticket_type_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__team AS SELECT id FROM team');
        $this->addSql('DROP TABLE team');
        $this->addSql('CREATE TABLE team (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        $this->addSql('INSERT INTO team (id) SELECT id FROM __temp__team');
